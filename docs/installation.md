...
AEF supports Python 3.11 through 3.14. The Python package version is
independent of the V1 workspace contract (`schema_version` `1.0.0`). Installing the command makes AEF
...
```powershell
py -3.11 -m pip install "agent-evolution-framework @ git+https://github.com/webdigit/agent-evolution-framework.git@v2.0.0"
aef --version
```
...
```console
python3 -m pip install --user "agent-evolution-framework @ git+https://github.com/webdigit/agent-evolution-framework.git@v2.0.0"
...
```powershell
py -m pip install "https://github.com/webdigit/agent-evolution-framework/releases/download/v2.0.0/agent_evolution_framework-2.0.0-py3-none-any.whl"
```
...
`SHA256SUMS.txt` from the [v2.0.0 release](https://github.com/webdigit/agent-evolution-framework/releases/tag/v2.0.0)
